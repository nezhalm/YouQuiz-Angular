...
@RestController
@RequestMapping("/api/assignQuizes")
@CrossOrigin
...
public class AssignQuizController {
    ...
    @PostMapping()
    public ResponseEntity<Map<String, Object>> save(@RequestBody AssignQuizDTO assignQuizDTO){
    ...
    @GetMapping()
    public ResponseEntity<Map<String, Object>> assignQuizzes()  {
        Map<String, Object> message = new HashMap<>();
        try{
