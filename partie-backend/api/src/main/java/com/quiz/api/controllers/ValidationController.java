...
//    }
    ...
    public ResponseEntity<Map<String, Object>> save(@RequestBody ValidationDTO validationDTO) throws Exception {
        ...
        try {
            if (validationService.existsQuestionAndResponse(validationDTO.getQuestionId(), validationDTO.getResponseId())) {
                message.put("message", "The question Id and response Id combination already exists in the database.");
